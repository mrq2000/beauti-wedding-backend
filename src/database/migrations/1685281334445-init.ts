...
export class init1685281334445 implements MigrationInterface {
    name = 'init1685281334445'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `templates` (`id` int NOT NULL AUTO_INCREMENT, `data` text NOT NULL, `preview_img_url` varchar(1023) NOT NULL, `status` tinyint NOT NULL DEFAULT '1', `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `designs_draft` (`design_id` int NOT NULL, `data` text NOT NULL, `template_id` int NOT NULL, `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, UNIQUE INDEX `REL_58c34055ab3e1688b9f6aec8fa` (`design_id`), PRIMARY KEY (`design_id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `designs_public` (`design_id` int NOT NULL, `data` text NOT NULL, `template_id` int NOT NULL, `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, UNIQUE INDEX `REL_eee5a328e94aac40fcf36eb8a8` (`design_id`), PRIMARY KEY (`design_id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `users` (`id` int NOT NULL AUTO_INCREMENT, `email` varchar(31) NOT NULL, `username` varchar(31) NOT NULL, `password` varchar(255) NOT NULL, `status` tinyint NOT NULL DEFAULT '1', `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, UNIQUE INDEX `IDX_fe0bb3f6520ee0469504521e71` (`username`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `designs` (`id` int NOT NULL AUTO_INCREMENT, `plan` tinyint NOT NULL DEFAULT '1', `domain` varchar(63) NOT NULL, `groom_name` varchar(63) NOT NULL, `groom_farther_name` varchar(63) NULL, `groom_mother_name` varchar(63) NULL, `bride_name` varchar(63) NOT NULL, `bride_farther_name` varchar(63) NULL, `bride_mother_name` varchar(63) NULL, `location` varchar(255) NULL, `time` varchar(63) NOT NULL, `user_id` int NOT NULL, `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, UNIQUE INDEX `IDX_2c0eff16949de92bd34b4a6057` (`domain`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
